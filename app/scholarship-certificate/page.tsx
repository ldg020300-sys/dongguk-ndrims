    ...
    <AcademicShell name={name}>
      ...
      <section className="scholarship-page">
        ...
        <div className="scholarship-filters">
          <label><b>년도/학기</b><select><option>-전체-</option><option>2026학년도 2학기</option></select></label>
          <fieldset><legend>출력언어</legend><label><input type="radio" defaultChecked /> 국문</label><label><input type="radio" /> 영문</label></fieldset>
          <label><b>명예장학</b><input type="checkbox" /></label>
          <button><Search size={17}/> 조회</button>
        </div>

        <div className="certificate-actions"><button onClick={() => window.print()}><Printer size={17}/> 인쇄</button></div>
        ...
        <article className="scholarship-certificate">
          ...
          <section className="certificate-section">
            ...
            <div className="certificate-grid student">
              ...
              <span>학번</span><strong>2026110432</strong>
              <span>학과</span><strong>약학과</strong>
              <span>학년</span><strong>1학년</strong>
            </div>
          </section>
          ...
          <p className="certificate-statement">상기 학생은 본교 장학금 지급 규정에 따라 아래와 같이 장학금을 수혜하였음을 증명합니다.</p>
